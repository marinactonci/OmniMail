    ...
    <div>
      <div className="flex min-h-screen items-center flex-col">
        ...
        <main className="flex-1">
          <section className="w-full h-[calc(100vh-64px)] grid place-items-center">
                ...
                <div className="flex flex-col justify-center space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="max-w-[600px] text-muted-foreground md:text-xl">
                      OmniMail enhances your email experience with AI-powered
                      text generation, smart autocomplete, and a chatbot that
                      answers questions about your inbox.
                    </p>
                  </div>
            ...
            <div className="container px-4 md:px-6">
              ...
              <div className="mx-auto grid max-w-5xl gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="flex flex-col items-start space-y-4 rounded-lg border bg-background p-6 shadow-sm">
                  ...
                  <p className="text-muted-foreground">
                    Get intelligent response suggestions that match your tone
                    and style with one-click replies.
                  </p>
                </div>
                <div className="flex flex-col items-start space-y-4 rounded-lg border bg-background p-6 shadow-sm">
                  <div className="rounded-full bg-primary/10 p-3">
                ...
                <div className="flex flex-col items-start space-y-4 rounded-lg border bg-background p-6 shadow-sm">
                  ...
                  <p className="text-muted-foreground">
                    Comprehensive insights into your email habits, response
                    times, and productivity metrics.
                  </p>
                </div>
                <div className="flex flex-col items-start space-y-4 rounded-lg border bg-background p-6 shadow-sm">
                  <div className="rounded-full bg-primary/10 p-3">
            ...
            <div className="container px-4 md:px-6">
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                  ...
                  <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                    OmniMail combines cutting-edge AI with intuitive keyboard
                    shortcuts to transform how you handle email.
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-muted-foreground">
                        Our AI analyzes your writing style to provide better
                        text suggestions and more relevant autocomplete options.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
              ...
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                  ...
                  <p className="mx-auto max-w-[700px] md:text-xl">
                    ...
                    inbox and boosted their productivity.
                  </p>
                </div>
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  <Button size="lg" className="h-12">
